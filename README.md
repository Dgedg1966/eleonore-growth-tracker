# Suivi de Croissance d'Éléonore 🍼
📈 Éléonore Growth Tracker
Application web qui visualise les données de croissance et de nutrition de la petite Éléonore (née le 14 mai 2025).
...
Interface responsive	Construite avec React, Tailwind CSS et Recharts – fonctionne sur ordinateur et mobile.
PWA	Manifest + icônes pwa-192x192.png et pwa-512x512.png (déclarées dans le vite.config.js).
...
Déployer – chaque push sur la branche suivie déclenche automatiquement le build et le déploiement.
...
Testez les endpoints du back‑end directement : https://<backend>.onrender.com/growth et …/nutrition renvoient du JSON.
...
Committez : git commit -m "Add …" puis git push origin ma-nouvelle-fonction.
...
📜 Licence
Ce projet est distribué sous licence MIT. Vous êtes libre d’utiliser, modifier et redistribuer le code, à condition de conserver le copyright et les mentions de licence.
